...
CREATE TABLE `course_announcements` (
  ...
  PRIMARY KEY (`Course_Announcements_Id`),
  KEY `fk_Course_Announcements_Course1_idx` (`Course_Course_Id`),
  CONSTRAINT `fk_Course_Announcements_Course1` FOREIGN KEY (`Course_Course_Id`) REFERENCES `course` (`Course_Id`)
...
-- Dump completed on 2022-12-04 20:43:36
